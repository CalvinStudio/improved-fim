...
#define SWAP(type, a, b) \
	...
	// __device__ double diff3d_2(int ix, int iy, int iz, Frame vel_grid,
	...
	//     float aa2, bb2, cc2;
	//     float aa3, bb3, cc3;
	//     float trav, trav11, trav2, trav3, trav4, travm, time_grad_vec_length;
	//     int xtmp, ytmp, ztmp;
	...
	//     trav = UINT_MAX, trav11 = UINT_MAX, trav2 = UINT_MAX, trav3 = UINT_MAX,
	//     trav4 = UINT_MAX, travm = UINT_MAX, time_grad_vec_length = 0.0f;
	//     xtmp = ix;
	//     ytmp = iy;
	//     ztmp = iz;
	//     if (ix == nnx)
	...
	//                     if (time_grad_vec_length < 0.0f)
	//                         time_grad_vec_length = 0.0f;
	//                     trav2 = (-bb + sqrt(time_grad_vec_length)) / (2.0f * aa);
	...
	// __device__ double diff3d_2diag(int ix, int iy, int iz, Frame vel_grid,
	//                                float *_vel, double *ttn)
	// {
	//     set_frame_nd(vel_grid);
	//     int nnx = n_rows;
